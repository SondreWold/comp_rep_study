...
RESULT_DIR = CURR_FILE_DIR / "composite_evaluations"
...
def run_mask_evaluation(
    ...
    for mask_name in mask_models:
        ...
        model = load_model(model_path, True, base_model)
...
def main() -> None:
    ...
    output_path = RESULT_DIR / "composite_evaluation_results.json"
