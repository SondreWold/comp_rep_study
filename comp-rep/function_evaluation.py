"""
Evaluate base model and masked models on the individual functions
"""
...
def load_model(
    path: Path, is_masked: bool, pruning_method: Literal["sampled", "continuous"]
):
    if is_masked:
...
def main() -> None:
    ...
    output_path = args.output_path / "complete_results.json"
